...
setup(
    ...
    install_requires=['beautifulsoup4==4.8.1','certifi==2019.9.11','cffi==1.13.2','chardet==3.0.4','Click==7.0',
                      ...
                      'peewee==3.11.2', 'psycopg2==2.8.4', 'pycparser==2.19', 'requests==2.22.0', 'six==1.13.0', 'soupsieve==1.9.5', 'traceback2==1.4.0', 'unittest2==1.1.0', 'urllib3==1.26.5', 'Werkzeug==0.16.0']
)
